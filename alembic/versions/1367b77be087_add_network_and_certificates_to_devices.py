...
def upgrade() -> None:
    ...
    op.alter_column('devices', 'serial', new_column_name='serial_number',
                    existing_type=sa.String(30), existing_nullable=False)
    op.alter_column('devices', 'battery_level', new_column_name='battery_status',
    ...
    op.alter_column('devices', 'connection_status', existing_type=sa.String(20),
                    existing_nullable=True, nullable=False)
    op.alter_column('devices', 'enrollment_status', existing_type=sa.String(20),
                    existing_nullable=True, nullable=False)
    op.alter_column('devices', 'created_at', existing_type=sa.DateTime(),
                    existing_nullable=True, nullable=False)
    op.alter_column('devices', 'updated_at', existing_type=sa.DateTime(),
                    existing_nullable=True, nullable=False)
    op.alter_column('devices', 'last_enrolled_at', existing_type=sa.DateTime(),
                    existing_nullable=True, nullable=False)
...
def downgrade() -> None:
    ...
    # rename back
    op.alter_column('devices', 'battery_status', new_column_name='battery_level',
                    existing_type=sa.Integer(), existing_nullable=True)
    op.alter_column('devices', 'serial_number', new_column_name='serial',
                    existing_type=sa.String(30), existing_nullable=False)

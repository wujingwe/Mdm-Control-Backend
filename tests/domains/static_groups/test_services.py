...
class TestStaticGroupService:
    ...
    def _svc(
        ...
        return StaticGroupService(repo, profile_repo, mobile_app_repo, reconciliation_service)

    async def test_list_groups(
        self, repo: MagicMock, profile_repo: MagicMock, mobile_app_repo: MagicMock, reconciliation_service: MagicMock
    ) -> None:
        svc = self._svc(repo, profile_repo, mobile_app_repo, reconciliation_service)
